...
mongoose.connect("mongodb+srv://adityarai:amanrai1234@cluster0.j5i9e5g.mongodb.net/",{ useNewUrlParser: true, useUnifiedTopology: true },()=>{console.log("Connected to db")});
